...
def t():
    label_list = sorted(glob.glob(os.path.join(
        r"G:/CY/CodesOfCy/new/PMFormer-main/DATASET/PMFormer_raw/PMFormer_raw_data/Task02_Synapse/labelsTs",
        '*nii.gz')))
    dest_file = r"G:\CY\results\Fourth\Synapse\fold_2\model_final_checkpoint"
    infer_list = sorted(

...
from pmformer.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
if __name__ == '__main__':
    training_output_folder1 = "G:/CY\CodesOfCy/new/PMFormer-main/DATASET/PMFormer_trained_models/PMFormer/3d_fullres/Task001_ACDC/PMFormerTrainerV2_pmformer_acdc__PMFormerPlansv2.1"
    plans = load_pickle(join(training_output_folder1, "plans.pkl"))
    output_folder = "G:/CY/CodesOfCy/new/PMFormer-main/DATASET/PMFormer_trained_models/PMFormer/ensembles/Task001_ACDC/ensemble_3d_fullres__PMFormerTrainerV2_pmformer_acdc__PMFormerPlansv2.1--3d_fullres__PMFormerTrainerV2_pmformer_acdc__PMFormerPlansv2.1"
    ...
    out_files=[]
    gt_segmentations=[]
    folder_with_gt_segs = "G:/CY/CodesOfCy/new/PMFormer-main/DATASET/PMFormer_raw/PMFormer_raw_data/Task01_ACDC/labelsTr"

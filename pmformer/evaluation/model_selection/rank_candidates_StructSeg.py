...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'PMFormerTrainerV2_2': ["PMFormerPlans", "PMFormerPlans_customClip"], # r
        'PMFormerTrainerV2_2_noMirror': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_lessMomentum_noMirror': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_2_structSeg_noMirror': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_2_structSeg': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_lessMomentum_noMirror_structSeg': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_FabiansResUNet_structSet_NoMirror': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r
        'PMFormerTrainerV2_FabiansResUNet_structSet': ["PMFormerPlans", "PMFormerPlans_customClip"],  # r

    }

    trainers = ['PMFormerTrainer'] + [
        'PMFormerTrainerV2_2',
        'PMFormerTrainerV2_lessMomentum_noMirror',
        'PMFormerTrainerV2_2_noMirror',
        'PMFormerTrainerV2_2_structSeg_noMirror',
        'PMFormerTrainerV2_2_structSeg',
        'PMFormerTrainerV2_lessMomentum_noMirror_structSeg',
        'PMFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'PMFormerTrainerV2_FabiansResUNet_structSet_NoMirror',
        'PMFormerTrainerV2_FabiansResUNet_structSet',
    ]

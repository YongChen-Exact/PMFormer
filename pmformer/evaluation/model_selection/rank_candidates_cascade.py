...
if __name__ == "__main__":
    ...
    plans = "PMFormerPlansv2.1"

    overwrite_plans = {
        'PMFormerTrainerCascadeFullRes': ['PMFormerPlans'],
    }

    trainers = [
        'PMFormerTrainerCascadeFullRes',
        'PMFormerTrainerV2CascadeFullRes_EducatedGuess',
        'PMFormerTrainerV2CascadeFullRes_EducatedGuess2',
        'PMFormerTrainerV2CascadeFullRes_EducatedGuess3',
        'PMFormerTrainerV2CascadeFullRes_lowerLR',
        'PMFormerTrainerV2CascadeFullRes',
        'PMFormerTrainerV2CascadeFullRes_noConnComp',
        'PMFormerTrainerV2CascadeFullRes_shorter_lowerLR',
        'PMFormerTrainerV2CascadeFullRes_shorter',
        'PMFormerTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',

...
def t():
    label_list = sorted(glob.glob(os.path.join(
        r"G:/CY/CodesOfCy/new/PMFormer-main/DATASET/PMFormer_raw/PMFormer_raw_data/Task05_Heart/labelsTs",
        '*nii.gz')))
    dest_file = r"G:\CY\CodesOfCy\new\PMFormer-main\DATASET\PMFormer_trained_models\PMFormer\3d_fullres\Task005_Heart\PMFormerTrainerV2_pmformer_heart__PMFormerPlansv2.1\fold_0\model_best"
    infer_list = sorted(

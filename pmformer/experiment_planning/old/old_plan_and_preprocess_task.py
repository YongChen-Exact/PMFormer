...
from pmformer.experiment_planning.utils import split_4d, crop, analyze_dataset, plan_and_preprocess
from batchgenerators.utilities.file_and_folder_operations import *
from pmformer.paths import PMFormer_raw_data
...
if __name__ == "__main__":
    ...
    if task == "all":
        all_tasks = subdirs(PMFormer_raw_data, prefix="Task", join=False)
        for t in all_tasks:
        ...
        if not use_splitted or not isdir(join(PMFormer_raw_data, task)):

...
class ExperimentPlanner3D_IsoPatchesInVoxels(ExperimentPlanner):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "PMFormerData_isoPatchesInVoxels"
        self.plans_fname = join(self.preprocessed_output_folder, "PMFormerPlans" + "fixedisoPatchesInVoxels_plans_3D.pkl")

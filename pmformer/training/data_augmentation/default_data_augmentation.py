...
from pmformer.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from pmformer.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'PMFormer_n_proc_DA' not in os.environ else int(os.environ['PMFormer_n_proc_DA']),
...
if __name__ == "__main__":
    from pmformer.training.dataloading.dataset_loading import DataLoader3D, load_dataset
    from pmformer.paths import preprocessing_output_dir
    import os
    import pickle

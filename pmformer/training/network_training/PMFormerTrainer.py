...
from pmformer.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from pmformer.training.loss_functions.dice_loss import DC_and_CE_loss
from pmformer.training.network_training.network_trainer import NetworkTrainer
...
class PMFormerTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from PMFormerTrainer and the init args change then you need to redefine self.init_args
        in your init accordingly. Otherwise checkpoints won't load properly!
        """
        super(PMFormerTrainer, self).__init__(deterministic, fp16)
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet(self.num_input_channels, self.base_num_features, self.num_classes, net_numpool,
                                    ...
                                    dropout_op_kwargs,
                                    net_nonlin, net_nonlin_kwargs, False, False, self.tmp_func, InitWeights_He(1e-2),
    ...
    def run_training(self):
        ...
        super(PMFormerTrainer, self).run_training()
    ...
    def preprocess_patient(self, input_files):
        ...
        assert preprocessor_class is not None, "Could not find preprocessor %s in pmformer.preprocessing" % \
                                               preprocessor_name
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(PMFormerTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()

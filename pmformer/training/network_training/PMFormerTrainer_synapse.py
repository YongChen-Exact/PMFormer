...
from pmformer.training.network_training.network_trainer_synapse import NetworkTrainer
...
class PMFormerTrainer_synapse(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(PMFormerTrainer_synapse, self).__init__(deterministic, fp16)
        ...
        print(self.batch_dice,"batch_dice")
    ...
    def run_training(self):
        ...
        super(PMFormerTrainer_synapse, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(PMFormerTrainer_synapse, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()

...
from pmformer.network_architecture.PMFormer_tumor import PMFormer
...
class PMFormerTrainerV2_pmformer_tumor(PMFormerTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = PMFormer(crop_size=self.crop_size,

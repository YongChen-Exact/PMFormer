...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, PMFormerTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "PMFormerTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, PMFormerTrainer), "network_trainer was found but is not derived from " \
                                                         "PMFormerTrainer"

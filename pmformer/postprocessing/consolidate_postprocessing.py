...
if __name__ == "__main__":
    ...
    folder = args.f
    # output_folder_base = "G:/CY/CodesOfCy/new/PMFormer-main/DATASET/PMFormer_trained_models/PMFormer/3d_fullres/Task001_ACDC/PMFormerTrainerV2_pmformer_acdc__PMFormerPlansv2.1"
    # output_folder_gt = "G:/CY/CodesOfCy/new/PMFormer-main/DATASET/PMFormer_raw/PMFormer_raw_data/Task01_ACDC/labelsTs"
    # determine_postprocessing(output_folder_base, output_folder_gt, 'cv_niftis_raw',
